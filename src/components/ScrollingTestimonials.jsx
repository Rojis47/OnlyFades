  ...
  return (
    <div className="py-12 bg-slate-950">
      <div className="px-4 mb-8">
        <h3 className="text-4xl font-semibold text-center text-slate-50">
          Testimonials
        </h3>
        <p className="max-w-lg mx-auto mt-2 text-sm text-center text-slate-300">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus
          consequatur reprehenderit.
        </p>
      </div>
      <div className="relative p-4 overflow-x-hidden">
        <div className="absolute top-0 bottom-0 left-0 z-10 w-24 bg-gradient-to-r from-slate-900 to-transparent" />
        ...
        <div className="absolute top-0 bottom-0 right-0 z-10 w-24 bg-gradient-to-l from-slate-900 to-transparent" />
      </div>
    </div>
  );
};
      ...
      {list.map((t) => {
        return (
          ...
          >
            ...
            <div className="p-4 bg-slate-900 text-slate-50">
              <span className="block mb-1 text-lg font-semibold">{t.name}</span>
  ...
  top: [
    {
      ...
      name: 'Gilbert C.',
      title: '',
      info: 'BEST CUT I EVER HAD! My boy Devin Garcia is NICE with the clippers! It was my first time here and I always get anxiety when going to a new shop. But let me tell you the professionalism and VIBES are felt as soon as you walk in.',
    },
    {
      id: 2,
