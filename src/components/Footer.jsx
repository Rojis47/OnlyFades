const navigation = {
  ...
  social: [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/profile.php?id=100092611486293',
      icon: (props) => (
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/onlyfadesbarbershop/',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    <footer className="bg-gray-900">
      <div className="px-6 py-20 mx-auto overflow-hidden max-w-7xl sm:py-24 lg:px-8">
        ...
        <div className="flex justify-center mt-10 space-x-10">
          {navigation.social.map((item) => (
            <a
              key={item.name}
              href={item.href}
              className="text-gray-400 duration-300 ease-in-out hover:text-blue-500"
            >
        ...
        <p className="mt-10 text-xs leading-5 text-center text-gray-500">
          &copy; 2023 Only Fades, All rights reserved.
        </p>
      </div>
    </footer>
  );
